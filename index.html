...
<head>
   ...
   <!-- Favicons
	================================================== -->
	<link rel="shortcut icon" href="images/my_icon_01_iyr_icon.ico" >
   ...
   <header id="home">
      ...
      <div class="row banner overlay">
         <div class="banner-text">
            <h1 class="responsive-headline">I'm Oreinz Kasilag.</h1>
            <h3>I'm an IT graduate with Intership experiences in 
               <span>graphic</span> and 
               <span>web design</span>
               I come to the industry with my skill in
               <span>HTML</span>, 
               <span>CSS</span>, 
               <span>Bootstrap</span>, 
               <span>Jquery</span>, 
               ...
               <span>Linux</span>, 
               <span>WordPress</span>, 
               <span>Photoshop</span> and 
               <span>Illustrator</span>
               and wish to utilise this alongside my soft skills, 
               so I can build a carreer path in the field.
            </h3>
            <hr />
            <ul class="social">
               <li><a href="https://www.facebook.com/oreinz.kasilag"><i class="fa fa-facebook"></i></a></li>
         ...
         <div class="nine columns main-col">
            ...
            <div class="row ">
               <div class="bars six columns">
                  <ul class="skills">
                     <li><span class="bar-expand html"></span><em>HTML 5</em></li>
                     <li><span class="bar-expand css"></span><em>CSS</em></li>
                     <li><span class="bar-expand bootstrap"></span><em>Bootstrap 3 and 4</em></li>
               ...
               <div class="bars six columns">
                   <ul class="skills">
                     ...
                     <li><span class="bar-expand wordpress"></span><em>Word Press</em></li>
   ...
   <footer>
      ...
      <div class="row">
         ...
         <div class="twelve columns">
            ...
            <ul class="copyright">
               <li>&copy; Copyright 2019 Oreinz Kasilag</li> 
            </ul>
